...
final class AiIndexBuildCommand extends Command
{
    protected function configure(): void
    {
        $this
            ->setName('ai:index-build')
            ->setDescription('Build or refresh the AI project index.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        try {
            ...
            if ($input->getOption('json')) {
                ...
                $output->writeln("<info>AI index built: {$index['indexPath']} ({$index['classCount']} classes)</info>");
            }
