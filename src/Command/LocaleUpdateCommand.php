...
final class LocaleUpdateCommand extends Command
{
    protected function configure(): void
    {
        $this
            ...
            ->setAliases(['translation:update'])
            ->setDescription('Update an existing translation value for a locale.')
    ...
    {
        try {
            $file = (new LocaleTranslationController((string) $input->getOption('base')))->updateTranslation(
            ...
            $output->writeln("<info>Translation updated: {$file}</info>");
